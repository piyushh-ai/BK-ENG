import{r as e}from"./rolldown-runtime-Dw2cE7zH.js";import{d as t,h as n,i as r,l as i,m as a,n as o,r as s,u as c}from"./react-vendor-Cm1STAwb.js";import{r as l}from"./vendor-D4tGl24r.js";import{a as u,c as d,d as f,f as p,i as m,l as h,n as g,o as _,p as v,s as y,t as b,u as x}from"./sales.slice-DHShqFC7.js";import{t as S}from"./useAuth-BW70zOfJ.js";import{t as C}from"./gsap-vendor-TDMdzdWV.js";var w=e(n(),1),T=e(a(),1),E=r(),D=l.create({baseURL:`/api`,withCredentials:!0}),O=async()=>(await D.get(`/getStock/company-sheets`)).data,k=async(e,{page:t=1,limit:n=12,search:r=``}={})=>(await D.get(`/getStock/company-stock/${e}`,{params:{page:t,limit:n,search:r}})).data,A=async({page:e=1,limit:t=12,search:n=``}={})=>(await D.get(`/getStock/boschStock`,{params:{page:e,limit:t,search:n}})).data,j=async({page:e=1,limit:t=12,search:n=``}={})=>(await D.get(`/getStock/master-search`,{params:{page:e,limit:t,search:n}})).data,M=async e=>(await D.post(`/salesOrder/create`,e,{headers:{"Content-Type":`multipart/form-data`}})).data,N=async({page:e=1,limit:t=10}={})=>(await D.get(`/salesOrder/my`,{params:{page:e,limit:t}})).data,P=async e=>(await D.get(`/salesOrder/${e}`)).data,F=async e=>(await D.get(`/salesOrder/search`,{params:{q:e}})).data,I=async e=>(await D.delete(`/salesOrder/${e}`)).data,L=()=>{let e=o();return{fetchCompanySheets:async()=>{try{e(h(!0)),e(_((await O()).companySheets||[]))}catch(t){e(d(t?.response?.data?.message||t.message))}finally{e(h(!1))}},fetchCompanyStock:async(t,n)=>{try{e(h(!0)),e(y((await k(t,n)).companyStock||[]))}catch(t){e(d(t?.response?.data?.message||t.message))}finally{e(h(!1))}},fetchBoschStock:async t=>{try{e(h(!0)),e(u((await A(t)).boschStock||[]))}catch(t){e(d(t?.response?.data?.message||t.message))}finally{e(h(!1))}},createOrder:async t=>{e(f(!0));try{let n=await M(t);return e(b(n.order)),n}catch(t){let n=t?.response?.data?.message||t.message;throw e(d(n)),Error(n)}finally{e(f(!1))}},fetchMyOrders:async({page:t=1,limit:n=10}={})=>{e(f(!0));try{let r=await N({page:t,limit:n});e(x(r.orders||[])),e(p(r.pagination||null))}catch(t){e(d(t?.response?.data?.message||t.message))}finally{e(f(!1))}},fetchOrderById:async t=>{e(f(!0));try{let n=await P(t);return e(m(n.order)),n.order}catch(t){let n=t?.response?.data?.message||t.message;throw e(d(n)),Error(n)}finally{e(f(!1))}},searchOrders:async t=>{e(f(!0));try{e(v((await F(t)).orders||[]))}catch(t){e(d(t?.response?.data?.message||t.message))}finally{e(f(!1))}},deleteOrder:async t=>{e(f(!0));try{return await I(t),e(g(t)),!0}catch(t){let n=t?.response?.data?.message||t.message;throw e(d(n)),Error(n)}finally{e(f(!1))}}}},R=7,z=({onSuccess:e})=>{let{createOrder:t}=L(),n=s(e=>e.sales.orderLoading),[r,i]=(0,w.useState)(``),[a,o]=(0,w.useState)(``),[c,l]=(0,w.useState)([]),[u,d]=(0,w.useState)(``),[f,p]=(0,w.useState)(!1),m=(0,w.useRef)(null),h=(0,w.useRef)(null),g=(0,w.useRef)(null),_=(0,w.useRef)(null),v=(0,w.useRef)(null),y=(0,w.useRef)(null),b=(0,w.useRef)(null),x=(0,w.useRef)(null),S=(0,w.useRef)(null);(0,w.useEffect)(()=>{let e=[g.current,_.current,v.current,y.current,b.current];C.set(e,{opacity:0,y:18}),C.timeline({defaults:{ease:`power3.out`}}).to(m.current,{opacity:1,duration:0}).to(e,{opacity:1,y:0,duration:.4,stagger:.07})},[]);let T=e=>{let t=Array.from(e.target.files||[]),n=R-c.length,r=t.slice(0,n).map(e=>({file:e,preview:URL.createObjectURL(e)}));l(e=>[...e,...r]),e.target.value=``},D=e=>{l(t=>(URL.revokeObjectURL(t[e].preview),t.filter((t,n)=>n!==e)))},O=()=>{C.to(m.current,{x:[-8,8,-6,6,-3,3,0],duration:.45,ease:`none`})};return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(`style`,{children:`
        .co-card {
      ...
      `}),(0,E.jsxs)(`div`,{ref:T,className:`oh-wrap`,children:[(0,E.jsxs)(`div`,{ref:D,className:`oh-header`,children:[(0,E.jsx)(`div`,{className:`oh-eyebrow`,children:`Order History`}),(0,E.jsx)(`div`,{className:`oh-title`,children:`My Orders`}),(0,E.jsx)(`div`,{className:`oh-sub`,children:`Track and manage all your submitted orders.`})]}),(0,E.jsxs)(`div`,{ref:O,className:`oh-search-wrap`,children:[(0,E.jsx)(`span`,{className:`oh-search-icon`,children:`🔍`}),(0,E.jsx)(`input`,{className:`oh-search`,type:`text`,placeholder:`Search by party name...`,value:c,onChange:e=>l(e.target.value)}),c&&(0,E.jsx)(`button`,{className:`oh-search-clear`,onClick:()=>l(``),title:`Clear`,children:`✕`})]}),a&&j.length===0?(0,E.jsx)(`div`,{className:`oh-loader`,children:`Loading orders…`}):j.length===0?(0,E.jsxs)(`div`,{className:`oh-empty`,children:[(0,E.jsx)(`div`,{className:`oh-empty-icon`,children:u?`🔎`:`📋`}),(0,E.jsx)(`div`,{className:`oh-empty-title`,children:u?`No results found`:`No orders yet`}),(0,E.jsx)(`div`,{className:`oh-empty-sub`,children:u?`No orders match "${c}". Try a different name.`:`Your submitted orders will appear here.`})]}):(0,E.jsxs)(E.Fragment,{children:[u&&(0,E.jsxs)(`div`,{className:`oh-search-label`,children:[`Showing results for `,(0,E.jsx)(`span`,{children:c}),` — `,j.length,` found`]}),(0,E.jsx)(`div`,{ref:k,children:j.map((e,t)=>(0,E.jsx)(J,{order:e,isLatest:!u&&t===0,onDeleteRequest:_,onClickDetail:h,onImageClick:x},e._id))}),!u&&i&&i.totalPages>1&&(0,E.jsxs)(`div`,{className:`oh-pagination`,children:[(0,E.jsxs)(`span`,{className:`oh-pg-info`,children:[`Page `,i.currentPage,` of `,i.totalPages,`\xA0· `,i.total,` orders total`]}),(0,E.jsxs)(`div`,{className:`oh-pg-btns`,children:[(0,E.jsx)(`button`,{className:`oh-pg-btn`,disabled:!i.hasPrevPage,onClick:()=>p(e=>e-1),children:`← Prev`}),(0,E.jsx)(`button`,{className:`oh-pg-btn`,disabled:!i.hasNextPage,onClick:()=>p(e=>e+1),children:`Next →`})]})]})]})]}),(0,E.jsx)(K,{isOpen:!!g,onClose:()=>_(null),onConfirm:A,orderName:g?.partyName,loading:v}),(0,E.jsx)(q,{isOpen:!!m,onClose:()=>h(null),order:m,onImageClick:x}),(0,E.jsx)(G,{isOpen:!!b,onClose:()=>x(null),imageUrl:b})]})},X=({activeTab:e,onTabChange:t})=>{let n=s(e=>e.auth.user),{logout:r}=S(),a=i(),[o,c]=(0,w.useState)(!1),l=(0,w.useRef)(null),u=(0,w.useRef)(null),d=(0,w.useRef)(null),f=(0,w.useRef)({}),p=[{id:`overview`,label:`Dashboard`,icon:(0,E.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,style:{width:`20px`,height:`20px`},children:[(0,E.jsx)(`path`,{d:`m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z`}),(0,E.jsx)(`polyline`,{points:`9 22 9 12 15 12 15 22`})]})},{id:`company`,label:`Co. Stock`,icon:(0,E.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,style:{width:`20px`,height:`20px`},children:[(0,E.jsx)(`path`,{d:`M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z`}),(0,E.jsx)(`polyline`,{points:`3.27 6.96 12 12.01 20.73 6.96`}),(0,E.jsx)(`line`,{x1:`12`,y1:`22.08`,x2:`12`,y2:`12`})]})},{id:`bosch`,label:`Bosch`,icon:(0,E.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,style:{width:`20px`,height:`20px`},children:[(0,E.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,E.jsx)(`path`,{d:`M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20`}),(0,E.jsx)(`path`,{d:`M2 12h20`})]})},{id:`orders`,label:`Punch`,icon:(0,E.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,style:{width:`20px`,height:`20px`},children:[(0,E.jsx)(`rect`,{width:`18`,height:`18`,x:`3`,y:`3`,rx:`2`}),(0,E.jsx)(`path`,{d:`M8 12h8`}),(0,E.jsx)(`path`,{d:`M12 8v8`})]})},{id:`history`,label:`History`,icon:(0,E.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,style:{width:`20px`,height:`20px`},children:[(0,E.jsx)(`path`,{d:`M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z`}),(0,E.jsx)(`path`,{d:`M14 2v6h6`}),(0,E.jsx)(`path`,{d:`M16 13H8`}),(0,E.jsx)(`path`,{d:`M16 17H8`}),(0,E.jsx)(`path`,{d:`M10 9H8`})]})}];(0,w.useEffect)(()=>{u.current&&C.fromTo(u.current,{y:-80,opacity:0},{y:0,opacity:1,duration:.7,ease:`power4.out`,onComplete:()=>C.set(u.current,{clearProps:`transform,y`})})},[]),(0,w.useEffect)(()=>{let t=f.current[e];if(!t||!d.current)return;let{offsetLeft:n,offsetWidth:r}=t;C.to(d.current,{x:n,width:r,duration:.38,ease:`power3.inOut`})},[e]),(0,w.useEffect)(()=>{let e=e=>{l.current&&!l.current.contains(e.target)&&c(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let m=async()=>{await r(),a(`/login`)},h=n?.name?n.name.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`SL`;return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(`style`,{children:`
