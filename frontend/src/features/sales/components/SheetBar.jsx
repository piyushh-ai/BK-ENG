...
const SheetBar = React.memo(
  ({ sheets, sheetsLoading, selectedSheet, onSheetSelect }) => {
    ...
    return (
      <>
        ...
        {drawerOpen && (
          <>
            <div
              className="sd-drawer-overlay open"
              ...
              <div className="sd-drawer-list">
                {(() => {
                  ...
                  if (filtered.length === 0)
                    return (
                      <div className="sd-drawer-empty">No sheets found</div>
                    );
                  return filtered.map((sheet) => {
                    ...
                    return (
                      ...
                      >
                        {name}
                        {isActive && (
                          <span className="sd-drawer-item-check">✓</span>
                        )}
                      </button>
                    );
                  });
