...
const AdminDashboard = () => {
  ...
  const onUpdateStock = async () => {
    ...
    // reset inputs by clearing them visually (re-render handles it via state)
  };
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 py-12 relative z-10 flex flex-col gap-12">
        {/* Header */}
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="relative group">
              ...
              <div
                className="relative flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-2xl transition-all duration-300 hover:border-primary"
                style={{
              ...
              >
                ...
                >
                  {boschFile ? boschFile.name : "Select Bosch Excel File"}
                </span>
                {!boschFile && (
                  <span
            ...
            <div className="relative group">
              ...
              >
                ...
                >
                  {companyFile ? companyFile.name : "Select Company Excel File"}
                </span>
                {!companyFile && (
                  <span
                    className="text-xs mt-1"
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            {uploadStatus && (
              <span
                className="font-semibold px-4 py-2 rounded-lg text-sm sm:text-base text-center w-full sm:w-auto"
                style={{
        ...
        <section ref={usersRef}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allSalesUsers?.map((user) => (
              <div
                key={user._id}
                className="p-6 rounded-2xl border shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group hover:-translate-y-1"
                style={{
                  background: "var(--color-surface-container-lowest)",
                  borderColor: "var(--color-outline-variant)",
                }}
              >
                ...
                <div className="flex items-start justify-between pl-4">
                  <div>
                    ...
                    <p
                      className="text-sm mb-4 truncate w-40 sm:w-48"
                      style={{ color: "var(--color-outline)" }}
                    >
                      {user.email}
                    </p>
                  ...
                  <div
                    className="w-14 h-14 rounded-full overflow-hidden border-2 shadow-sm"
                    style={{
                ...
                <div
                  className="mt-6 pt-4 border-t pl-4 flex items-center justify-between"
                ...
                >
                  ...
                  <button
                    ...
                    className="text-sm font-bold px-4 py-2 rounded-lg transition-colors shadow-sm"
                    style={{
                      background: "var(--color-surface-container)",
                      color: "var(--color-on-surface)",
                    }}
                  ...
                  >
                    Set to {user.role === "admin" ? "Sales" : "Admin"}
                  </button>
                </div>
              </div>
            ))}
