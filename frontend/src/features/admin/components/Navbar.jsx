...
const Navbar = ({ activeTab, onTabChange }) => {
  ...
  const tabs = [
    ...
    { 
      id: "all_orders", 
      label: "All Orders", 
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{width: '20px', height: '20px'}}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> 
    },
    { 
      id: "company", 
      label: "Co. Stock", 
        ...
        <div className="snav-inner">
          ...
          <div className="snav-right">
            ...
            <div className="snav-avatar-wrap" ref={dropRef}>
              <div className="snav-avatar" onClick={() => setDropdownOpen((p) => !p)} title="Account">
                {initials}
              ...
              {dropdownOpen && (
                <div className="snav-dropdown">
                  <div className="snav-drop-header">
                    <div className="snav-drop-name">{user?.name || "Administrator"}</div>
                    <div className="snav-drop-email">{user?.email || ""}</div>
                  </div>
                  <button className="snav-drop-item danger" onClick={handleLogout}>
                     Sign out
                  </button>
                </div>
              )}
